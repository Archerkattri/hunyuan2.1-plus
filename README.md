...
Shape generation uses the Hermite cache at the DiT boundary. Texture generation remains downstream and receives the same mesh contract as the unaccelerated pipeline.
