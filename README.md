...
<p>
  ...
  <a href="https://github.com/Archerkattri/hunyuan2.1-plus/releases"><img alt="Downloads" src="https://img.shields.io/github/downloads/Archerkattri/hunyuan2.1-plus/total?label=downloads&color=1f6feb"></a>
...
![hunyuan2.1-plus architecture](assets/readme_flow.svg)

HiCache attaches to the Hunyuan3D-2.1 flow loop and forecasts skipped DiT velocities with the scaled-Hermite backend.
