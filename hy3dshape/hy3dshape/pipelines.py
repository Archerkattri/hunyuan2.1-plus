...
class Hunyuan3DDiTPipeline:
    ...
    def get_hicache_status(self):
        """Return the Hermite baseline's enabled/disabled status."""
        cfg = getattr(self, "_hicache_cfg", None)
        if cfg is None:
            return {"enabled": False, "active": False, "backend": None, "reason": "disabled"}
        return {"enabled": True, "active": True, "backend": "hermite", "reason": None}
        ...
        with synchronize_timer('Diffusion Sampling'):
            ...
            for i, t in enumerate(tqdm(timesteps, disable=not enable_pbar, desc="Diffusion Sampling:")):
                ...
                if serve_forecast:
                    ...
                    # Hermite backend forecasts from finite-difference derivatives.
